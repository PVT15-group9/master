...
/**
 * Innehåller metoder för att hämta, uppdatera, spara, ta bort data från databasen.
 * @author Dmitri
 *
 */
@Repository
...
public class SensorDAO {
	...
	/**
	 * Uppdaterar en sensor genom att simulera alla värden och lägga till dem i listan.
	 * @param sensor
	 * @return
	 */
