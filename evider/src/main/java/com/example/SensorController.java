...
public class SensorController {
	...
	public void updateSensor() throws Exception{
		try {
			...
			/**
			 * kontrollerar om det finns en sensor med den starttiden. om den inte finns så sparas den i listan för nya events
			 */
			...
			/**
			 * om listan är ej tom så skapas en ny sensor och sparas i databasen.
			 */
	...
	/**
	 * Tar bort sensorer som har tomma listor, uppdaterar värden i listor och sparar ett nytt värde för varje sensor, tar bort det gamla värdet från varje sensorns listan. görs varje minut.
	 * @throws Exception
	 */
	...
	/**
	 * En Event klass för kunna hämta events från databasen då uppbygnaden är lite annorlunda. events tabellen hårdkodas och sensor tabellen skapas dynamiskt.
	 * @author Dmitri
	 *
	 */
	private class Event{
